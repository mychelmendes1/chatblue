...
# Copy sheet component
spawn scp -o StrictHostKeyChecking=no ${local_base}/apps/web/components/ui/sheet.tsx ${user}@${server}:/opt/chatblue/app/apps/web/components/ui/sheet.tsx
