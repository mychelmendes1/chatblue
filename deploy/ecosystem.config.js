  ...
  apps: [
    {
      ...
      instances: 1, // Baileys não pode rodar em cluster (conexão única)
      exec_mode: 'fork',
      env: {
        NODE_ENV: 'production',
        PORT: 3001,
        API_URL: 'https://chat.grupoblue.com.br',
        // Database and Redis URLs - PM2 doesn't automatically load env_file
        // These values must match what's in /opt/chatblue/.env
