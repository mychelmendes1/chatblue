...
spawn scp -o StrictHostKeyChecking=no \
    ${local_base}/apps/api/src/services/upload/upload.service.ts \
    ${user}@${server}:/tmp/upload.service.ts
...
send "cp /tmp/upload.service.ts /opt/chatblue/app/apps/api/src/services/upload/upload.service.ts\r"
expect "# "
...
expect "# "
send "test -f dist/services/upload/upload.service.js && echo 'Build OK' || echo 'ERRO: Arquivo não encontrado'\r"
expect "# "
