...
send "echo '=== Fazendo build forçado da API (ignorando erros) ==='\r"
expect "# "
...
send "echo '=== Verificando se o arquivo foi atualizado ==='\r"
expect "# "
send "grep -n 'isAllFilter' /opt/chatblue/app/apps/api/src/routes/ticket.routes.ts | head -3\r"
expect "# "
