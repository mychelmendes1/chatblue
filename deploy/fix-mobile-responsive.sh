...
# Copy updated files
spawn scp -o StrictHostKeyChecking=no ${local_base}/apps/web/components/layout/sidebar.tsx ${user}@${server}:/opt/chatblue/app/apps/web/components/layout/sidebar.tsx
expect "password:" { send "${password}\r" }
expect eof

spawn scp -o StrictHostKeyChecking=no ${local_base}/apps/web/components/layout/header.tsx ${user}@${server}:/opt/chatblue/app/apps/web/components/layout/header.tsx
expect "password:" { send "${password}\r" }
expect eof
...
spawn scp -o StrictHostKeyChecking=no ${local_base}/apps/web/app/globals.css ${user}@${server}:/opt/chatblue/app/apps/web/app/globals.css
expect "password:" { send "${password}\r" }
expect eof
