...
async function scheduleRecurringJobs() {
  ...
  // Collect training pairs every hour
  ...
  // Collect from AI transfers every 2 hours
  await mlTrainingCollectorQueue.add(
    "collect-transfers",
  ...
  // Score pending training pairs every 30 minutes
  ...
  // Full training weekly on Sundays at 3 AM
  await mlPatternDetectorQueue.add(
    "full-training",
